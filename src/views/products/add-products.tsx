...
export default function AddProduct() {
    const { register, formState: { errors }, handleSubmit } = useForm(formAddProduct);
        ...
        <div className='flex flex-col w-full space-y-6'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col justify-end items-end space-y-4'>
                <Card className='flex flex-col w-full space-y-6 p-6'>
                    ...
                    <InputTextarea register={register('description')} placeholder='Input your description' errMessage={errors.description?.message} label='Description' />
                </Card>
