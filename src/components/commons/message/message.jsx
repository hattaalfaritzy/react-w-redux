...
export default function Message({ type = 'error', label, className }) {
    ...
    return (
        <div className={clsx('flex justify-center items-center rounded-lg px-3 py-1.5 bg-opacity-20 w-full', style, className)}>
